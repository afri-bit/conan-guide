...
class Ui_TabCache(object):
    def setupUi(self, TabCache):
        ...
        self.verticalLayout_3.setContentsMargins(2, 2, 2, 5)
        ...
        self.toolButtonSortAscending = QToolButton(self.widget)
        ...
        self.toolButtonSortDescending = QToolButton(self.widget)
        ...
        self.toolButtonRemoveRecipe = QToolButton(self.widget)
        ...
        self.treeViewRecipe = QTreeView(self.widget)
        ...
        self.toolButtonRemovePackage = QToolButton(self.widget1)
        ...
        self.listViewPackage = QListView(self.widget1)
