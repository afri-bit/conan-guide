...
class Ui_TabProfile(object):
    ...
    def retranslateUi(self, TabProfile):
        ...
        self.toolButtonSortAscending.setText(QCoreApplication.translate("TabProfile", u"SoA", None))
        self.toolButtonSortDescending.setText(QCoreApplication.translate("TabProfile", u"SoD", None))
        self.toolButtonProfileAdd.setText("")
        self.toolButtonProfileRemove.setText("")
        self.toolButtonSaveChange.setText(QCoreApplication.translate("TabProfile", u"S", None))
        self.toolButtonRevertChange.setText(QCoreApplication.translate("TabProfile", u"R", None))
