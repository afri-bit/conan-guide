...
class Ui_TabProfile(object):
    def setupUi(self, TabProfile):
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icon/light/add.png", QSize(), QIcon.Normal, QIcon.Off)
        self.toolButtonProfileAdd.setIcon(icon2)
        ...
        self.toolButtonProfileRemove.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/icon/light/save.png", QSize(), QIcon.Normal, QIcon.Off)
        self.toolButtonSaveChange.setIcon(icon4)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/icon/light/revert.png", QSize(), QIcon.Normal, QIcon.Off)
        self.toolButtonRevertChange.setIcon(icon5)
...
#if QT_CONFIG(tooltip)
        self.toolButtonProfileAdd.setToolTip(QCoreApplication.translate("TabProfile", u"Add", None))
#endif // QT_CONFIG(tooltip)
